...
public class EightFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		return inflater.inflate(R.layout.eight, container, false);
	}
	...
	private void initView() {
		textView1=(TextView)getActivity().findViewById(R.id.eightA);
		textView2=(TextView)getActivity().findViewById(R.id.eightB);
		textView3=(TextView)getActivity().findViewById(R.id.eightC);
