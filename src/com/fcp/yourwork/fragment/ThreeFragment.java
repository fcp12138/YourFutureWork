...
public class ThreeFragment extends Fragment implements OnClickListener{
	...
	private void initView() {
		textView1=(TextView)getActivity().findViewById(R.id.threeA);
		textView2=(TextView)getActivity().findViewById(R.id.threeB);
		textView3=(TextView)getActivity().findViewById(R.id.threeC);
