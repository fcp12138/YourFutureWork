...
public class FiveFragment extends Fragment implements OnClickListener{
	...
	private void initView() {
		textView1=(TextView)getActivity().findViewById(R.id.fiveA);
		textView2=(TextView)getActivity().findViewById(R.id.fiveB);
		textView3=(TextView)getActivity().findViewById(R.id.fiveC);
