...
public class SevenFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		return inflater.inflate(R.layout.seven, container, false);
	}
	...
	private void initView() {
		textView1=(TextView)getActivity().findViewById(R.id.sevenA);
		textView2=(TextView)getActivity().findViewById(R.id.sevenB);
		textView3=(TextView)getActivity().findViewById(R.id.sevenC);
